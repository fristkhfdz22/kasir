...
// Query untuk mendapatkan semua barang, dengan pencarian jika ada
    ...
    <div class="container">
        ...
        <form method="POST" class="mb-3">
            <div class="input-group">
                <input type="text" class="form-control" name="search" value="<?php echo htmlspecialchars($search); ?>" placeholder="Cari Kode Barang atau Nama Barang">
        ...
        <strong>Total Bayar: Rp" . number_format($total_bayar_transaksi, 2, ',', '.') . "</strong>
                ...
                <form action="reset_transaksi.php" method="POST">
                    <button type="submit" class="btn btn-danger mt-4">Reset Transaksi</button>
                </form>
            </tbody>
        </table>
